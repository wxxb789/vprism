...
from vprism.core.exceptions import NoCapableProviderException
...
class MockProvider(DataProvider):
    def __init__(self, name: str, capability):
        from vprism.infrastructure.providers.base import AuthConfig, RateLimitConfig, AuthType
        super().__init__(
            name=name,
...
class TestDataRouter:
    ...
    def sample_providers(self):
        """创建示例提供商."""
        from vprism.infrastructure.providers.base import ProviderCapability
        
        return [
            MockProvider("tushare", ProviderCapability(
            ...
            MockProvider("yahoo", ProviderCapability(
            ...
            MockProvider("alpha_vantage", ProviderCapability(
    ...
    async def test_route_no_capable_provider(self, mock_registry):
        ...
        with pytest.raises(NoCapableProviderException) as exc_info:
