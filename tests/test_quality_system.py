...
class TestDataCleaner:
    ...
    def test_end_to_end_cleaning(self):
        ...
        df = pd.DataFrame({
            ...
            'open': [100.0, 101.0, np.nan, 103.0, 104.0, 105.0, 200.0, 107.0, 108.0, 109.0],
            'high': [101.0, 102.0, 103.0, 104.0, 105.0, 106.0, 201.0, 108.0, 109.0, 110.0],
            'low': [99.0, 100.0, 101.0, 102.0, 103.0, 104.0, 199.0, 106.0, 107.0, 108.0],
            'close': [100.5, 101.5, np.nan, 103.5, 104.5, 105.5, 200.5, 107.5, 108.5, 109.5],
