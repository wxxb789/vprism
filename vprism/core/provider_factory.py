...
class ProviderFactory:
    ...
    def _register_built_in_providers(self) -> None:
        ...
        try:
            ...
            logger.warning(
                "YfinanceProvider not available - yfinance dependency missing"
            )

        try:
            from vprism.core.providers.alpha_vantage_provider import (
    ...
    def register_provider_class(
        self, name: str, provider_class: Type[EnhancedDataProvider]
    ) -> None:
    ...
    def _create_yfinance_provider(
        ...
        try:
            ...
            logger.warning(
                "Cannot create YfinanceProvider - yfinance dependency missing"
            )
            return None
        except Exception as e:
    ...
    def _create_alpha_vantage_provider(
        self, config: ProviderConfig
    ) -> Optional[EnhancedDataProvider]:
    ...
    def _create_generic_provider(
        self, provider_class: Type[EnhancedDataProvider], config: ProviderConfig
    ) -> Optional[EnhancedDataProvider]:
