    ...
    def _setup_tools(self) -> None:
        ...
        async def get_stock_data(
            ...
            try:
                ...
                return {"error": f"Failed to get stock data: {str(e)}", "symbol": symbol}
        ...
        async def get_market_overview(
            ...
            try:
                    ...
                    try:
                        ...
                        if data.data and len(data.data) > 0:
                            ...
                            overview_data[symbol] = {
                                ...
                                "change_percent": float((point.close_price - point.open_price) / point.open_price * 100) if point.close_price and point.open_price else 0.0,
                ...
                return {"error": f"Failed to get market overview: {str(e)}", "market": market}
            ...
            try:
                ...
                if data.data and len(data.data) > 0:
                    ...
                    return {
                        ...
                        "change_percent": float((point.close_price - point.open_price) / point.open_price * 100) if point.close_price and point.open_price else None,
                        "volume": int(point.volume) if point.volume else None,
                ...
                return {"error": f"Failed to get real-time price: {str(e)}", "symbol": symbol}
                ...
                for symbol in symbols:
                    try:
                        ...
                        if data.data and len(data.data) > 0:
                            ...
                            results[symbol.upper()] = {"error": "No data available", "symbol": symbol.upper()}
                    except Exception as e:
        ...
        async def financial_analysis_prompt(symbol: str, timeframe: str = "1y") -> str:
            """
