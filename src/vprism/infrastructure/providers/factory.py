...
class ProviderFactory:
    ...
    @classmethod
    def create_yahoo_provider(cls,
                            rate_limit: Optional[RateLimitConfig] = None) -> YahooFinanceProvider:
    ...
    @classmethod
    def create_akshare_provider(cls,
                              rate_limit: Optional[RateLimitConfig] = None) -> AkShareProvider:
        """创建AkShare数据提供商.
    ...
    @classmethod
    def create_provider_by_market(cls,
                                market: MarketType,
