...
class DatabaseManager:
    ...
    def get_provider_record(self, name: str) -> Optional[Dict[str, Any]]:
        """获取提供商记录."""
    ...
    def get_cache_record(self, cache_key: str) -> Optional[Dict[str, Any]]:
        """获取缓存记录."""
        result = self.connection.execute(
    ...
    def cleanup_old_data(self, days_to_keep: int = 90) -> int:
        """清理旧数据记录."""
        cutoff_date = datetime.utcnow().replace(days=-days_to_keep)
        result = self.connection.execute(
