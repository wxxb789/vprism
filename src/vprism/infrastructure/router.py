...
class DataRouter:
    ...
    def get_provider_stats(self, provider_name: str) -> Optional[Dict[str, Any]]:
        """获取提供商统计信息.
    ...
    async def get_routing_decision_log(
        self, 
        query: DataQuery
    ) -> Dict[str, Any]:
        """获取路由决策日志，用于调试和分析.
