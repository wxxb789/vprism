...
- [ ] 4. 实现数据提供商适配器
  - [ ] 4.1 创建基础提供商适配器框架（TDD 方式）
    ...
    - 基于改进的 DataProvider 抽象类实现具体适配器
    - 实现多种认证方式：API_KEY、BEARER_TOKEN、BASIC_AUTH、OAUTH2
